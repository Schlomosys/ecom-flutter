...
import 'package:dextroecom/loaders/loader_animator.dart';
import 'package:dextroecom/map/map.dart';
import 'package:dextroecom/services/nominatim_service.dart';
import 'package:auto_size_text/auto_size_text.dart';

import 'login.dart';

class NominatimPicker extends StatefulWidget {
  NominatimPicker({
    this.userId,
  ...
  @override
  _NominatimPickerState createState() =>
      _NominatimPickerState();
}

class _NominatimPickerState extends State<NominatimPicker> {
  Map retorno;
        ...
        child: FittedBox(
          child:/*FlatButton(
            ...
            onPressed: () {
              ...
              print("CUrrernt Lat "+_currentPosition.latitude.toString());
              print("city "+_addresses[0]['city'].toString());
           ...
           //height: 45.0,
            child: Text(
              "Valider",
              style:
              TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 17.0, fontFamily: 'Montserrat',),
            ),
          ), */FloatingActionButton(
              ...
              onPressed: () {
                ...
                print("CUrrernt Lat "+_currentPosition.latitude.toString());
                print("city "+_addresses[0]['city'].toString());
                GeoPoint geopoint= new GeoPoint(_currentPosition.latitude, _currentPosition.latitude);
                UserService _userService= new UserService();
                _userService.updateUserLocationDetails(widget.userId, _addresses[0]['state'], _addresses[0]['description'], _addresses[0]['city'], _addresses[0]['suburb'], _addresses[0]['neighbourhood'], _addresses[0]['road'], _addresses[0]['description'],geopoint);

                Fluttertoast.showToast(
                    msg: "Votre adresse a été enregistrée avec succès",
